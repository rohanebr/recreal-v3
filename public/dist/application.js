...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('job-applications');'use strict';
// Use applicaion configuration module to register a new module
...
//Setting up route
angular.module('job-applications').config([
  '$stateProvider',
  function ($stateProvider) {
...
angular.module('job-applications').controller('EmployerJobCandidatesController', [
  '$scope',
  '$filter',
  '$state',
  'Jobs',
...
angular.module('job-applications').factory('JobApplications', [
  '$http',
  function ($http) {
